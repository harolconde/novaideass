...
export class IdeaComponent implements OnInit {
    ...
    getIdeaDetail() {
        ...
        this._service.getIdeaDetalle().subscribe((data) => {
            ...
            this.neg = this.ideas.VotesTypeDTO.VotesDislikeTotal
            this.neu = this.ideas.VotesTypeDTO.VotesNeutralTotal
    ...
    getCommentDetail() {
        this._service.getAllComents().subscribe((datac) => {
            this.comments = datac
            this._service.idIdeas = this.ideas.Id
            console.log(datac)
            console.log(`Comentario ${this.ideas.Id}`)
